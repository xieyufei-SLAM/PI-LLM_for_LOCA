...
torchrun --standalone --nproc_per_node=8 main_multi_gpus.py \
    --llm_path llm_weights/LLM-Research/Llama-3___2-3B \
    --train_pipelines 105 --epochs 1000 --batch_size 2  # 8-GPU training
```
